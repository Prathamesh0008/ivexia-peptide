      ...
      <div className="mx-auto flex min-h-[104px] w-full max-w-[1660px] items-center justify-between gap-7 px-4 sm:px-6 lg:px-16 xl:px-24 2xl:px-32">
        ...
        >
          <Image
            ...
            height={110}
            priority
            className="h-1 w-auto max-w-[310px] object-contain"
          />
        </Link>

        <div className="hidden flex-1 lg:block">
          <div className="mx-auto flex h-[60px] w-full max-w-[850px] items-center rounded-lg border border-[#C7C7C7] bg-white px-6 focus-within:ring-2 focus-within:ring-[#F04423]/20">
